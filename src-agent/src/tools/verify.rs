...
/// Timeout for running tests (seconds).
const TEST_TIMEOUT_SECS: u64 = 120;
/// Maximum timeout for check_output (seconds).
const CHECK_OUTPUT_TIMEOUT_MAX: u64 = 120;
/// Minimum/default timeout for check_output (seconds).
const CHECK_OUTPUT_TIMEOUT_MIN: u64 = 30;
